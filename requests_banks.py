...
def ge_state_rates():
	...
	result_dict = {'name_bank': 'state', 'country': 'gel',
...
def ge_rico_rates():
	...
	result_dict = {'name_bank': 'rico', 'country': 'gel', 'usd_sell': rico_usd_sell,
...
def ge_georgiabank_rates():
	...
	result_dict = {'name_bank': 'georgia', 'country': 'gel', 'usd_sell': geo_usd_sell,
...
def ge_mbc_rates():
	...
	result_dict = {'name_bank': 'mbc', 'country': 'gel', 'usd_sell': mbc_usd_sell,
...
def ge_basis_rates():
	...
	result_dict = {'name_bank': 'basis', 'country': 'gel', 'usd_sell': basis_usd_sell,
...
def ge_crystal_rates():
	...
	result_dict = {'name_bank': 'crystal', 'country': 'gel', 'usd_sell': crystal_usd_sell,'usd_buy': crystal_usd_buy, 'euro_sell': crystal_euro_sell, 'euro_buy': crystal_euro_buy,'lira_sell': crystal_lira_sell, 'lira_buy': crystal_lira_buy}
	return result_dict
...
def ge_credo_rates():
    ...
    result_dict = {'name_bank': 'credo', 'country': 'gel', 'usd_sell': credo_usd_sell,'usd_buy': credo_usd_buy, 'euro_sell': credo_euro_sell, 'euro_buy': credo_euro_buy,'lira_sell': None, 'lira_buy': None}
    return result_dict
...
def ru_tinkoff_rates():
	...
	result_dict = {'name_bank': 'tinkoff', 'country': 'rub', 'usd_sell': tinkoff_usd_sell,
...
def tr_isbank_rates():
	...
	result_dict = {'name_bank': 'is_bank', 'country': 'try', 'usd_sell': is_usd_sell,'usd_buy': is_usd_buy, 'euro_sell': is_euro_sell, 'euro_buy': is_euro_buy,'lira_sell': None, 'lira_buy': None}
	return result_dict
...
def tr_trabzon_rates():
	...
	result_dict = {'name_bank': 'trabzon', 'country': 'try', 'usd_sell': trabzon_usd_sell,'usd_buy': trabzon_usd_buy, 'euro_sell': trabzon_euro_sell, 'euro_buy': trabzon_euro_buy,'lira_sell': None, 'lira_buy': None}
	return result_dict
...
def by_prior_rates():
	...
	result_dict = {'name_bank': 'prior', 'country': 'byn', 'usd_sell': prior_usd_sell,'usd_buy': prior_usd_buy, 'euro_sell': prior_euro_sell, 'euro_buy': prior_euro_buy,'lira_sell': None, 'lira_buy': None}
	return result_dict
